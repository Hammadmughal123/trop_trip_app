...
class TripsReelsScreen extends StatefulWidget {
  const TripsReelsScreen({super.key});

  @override
  State<TripsReelsScreen> createState() => _TripsReelsScreenState();
}

class _TripsReelsScreenState extends State<TripsReelsScreen> {
  final ReelsController controller = Get.put(ReelsController());
  
  final List<String> videoPaths = [
    'assets/videos/l1.mp4',
    'assets/videos/l2.mp4',
    'assets/videos/l3.mp4',
  ];
