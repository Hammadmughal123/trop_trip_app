...
void showLoginSuccessDialog(BuildContext context, UserModel userModel, User firebaseUser) {
  showDialog(
    context: context,
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              const Padding(
                ...
                child: Text(
                  "You've successfully login to your account, let's begin to explore",
